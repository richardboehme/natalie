...
# NATFIXME: Support blocks with return statement
xdescribe "passed { |a, b = 1|  } creates a method that" do
  before :each do
    @klass = Class.new do
...
describe "Module#define_method" do
  ...
  # NATFIXME: Support blocks with return statement
  xdescribe "passed { |a, *b|  } creates a method that" do
    before :each do
      @klass = Class.new do
  ...
  # NATFIXME: Support blocks with return statement
  xdescribe "passed { |a, b, *c|  } creates a method that" do
    before :each do
      @klass = Class.new do
...
describe "Method#define_method when passed a Method object" do
  ...
  # NATFIXME: Implement Method#parameters
  xit "defines a method with the same #parameters as the original" do
...
describe "Method#define_method when passed a block" do
  describe "behaves exactly like a lambda" do
    ...
    # NATFIXME: Support blocks with break statement
    xit "for break" do
      Class.new do
        define_method(:foo) do
          break 42
    ...
    # NATFIXME: Make redo statement work
    xit "for redo" do
      Class.new do
        result = []
        define_method(:foo) do
